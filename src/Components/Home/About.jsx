...
const About = () => {
  return (
    <div data-scroll data-scroll-speed="2" className="bg-[#9bc43c]">
        ...
        <div className='w-full text-black rounded-3xl rounded-tr-3xl py-10'>
          ...
          <div className='w-full flex flex-col lg:flex-row gap-10 pt-10 mt-10 border-t-[1px] border-[#374518]'>
            ...
            <div className='w-full lg:w-1/2'>
              ...
              <button className='uppercase flex items-center gap-4 px-6 py-3 sm:py-4 mt-6 sm:mt-10 bg-gray-900 rounded-full text-white text-sm sm:text-md'>
                Read More
