...
const Eyes = () => {
  ...
  return (
    <div className='eyes w-full overflow-hidden px-4'>
      <div
        data-scroll
        data-scroll-speed='-.5'
        className='relative w-full max-w-[500px] md:max-w-full mx-auto h-[60vh] md:h-screen bg-cover bg-center rounded-xl overflow-hidden bg-[url(https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-1440x921.jpg)] py-10 md:py-0'
      >
