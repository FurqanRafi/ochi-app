...
const Header = () => {
    ...
    return (
        <header className="fixed z-[999] w-full px-6 md:px-12 lg:px-20 py-4 md:py-5 backdrop-blur-md bg-#f2f2f2/70 shadow-md">
                ...
                <Link href="/">
                    <div className="block w-[72px] h-auto cursor-pointer">
                        <svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M62.8086 29.4855H67.1222V10.6372H62.8086V29.4855Z" fill="currentColor"></path><path d="M67.6816 0.172852V6.13439H71.5322C71.6738 6.13439 71.8046 6.13439 72.0006 6.11534V0.172852H67.6816Z" fill="currentColor"></path>
                ...
                <nav className="hidden sm:flex flex-wrap justify-center gap-6 md:gap-10 text-sm md:text-base">
                    {navItems.map((item, index) => (
                        <Link key={index} href={`/${item.replace(/\s+/g, '').toLowerCase()}`}>
                            <div
                                className={`capitalize text-gray-800 hover:text-blue-600 transition duration-200 font-light ${index === 4 ? 'ml-0 md:ml-20' : ''} cursor-pointer`}
                            >
                                {item}
                            </div>
                        </Link>
